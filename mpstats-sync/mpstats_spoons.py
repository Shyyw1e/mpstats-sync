...
FIELD_MAPPING = {
    ...
    "Вес без упаковки": "Вес товара без упаковки (г)",
    "Вес товара без упаковки": "Вес товара без упаковки (г)",
    "Материал": "Материал изделия",
    "Материал изделия": "Материал изделия",
    "Количество предметов": "Количество предметов в упаковке",
    "Тип блесны": "Тип блесны",
    "Модель": "Модель блесны",
    "Вид крючка": "Вид крючка",
    "Длина приманки": "Длина приманки (мм)",
    "Вид рыбы": "Вид рыбы",
...
def get_spoon_info(sku: str, d1: str, d2: str) -> dict:
